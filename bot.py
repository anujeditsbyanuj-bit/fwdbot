...
class Bot(Client): 
    ...
    async def start(self):
        ...
        # Register the bot's command menu with Telegram (equivalent of BotFather's /setcommands)
        try:
            from pyrogram.types import BotCommand
            await self.set_bot_commands([
                BotCommand("start", "✨ Start the bot and register yourself"),
                BotCommand("free", "🆓 Get free Plus plan for 4 hours"),
                BotCommand("settings", "⚙️ Configure filters, captions & preferences"),
                BotCommand("forward", "🚀 Start manual forwarding"),
                BotCommand("fwd", "🚀 Start manual/auto forwarding"),
                BotCommand("cleartask", "⛔ Stop any active task instantly"),
                BotCommand("reset", "🔄 Reset all settings to default"),
                BotCommand("myplan", "💳 View your active subscription"),
                BotCommand("subscription", "📦 Check available plans"),
                BotCommand("plan", "📦 Check available plans"),
                BotCommand("referral", "🎁 Open referral dashboard & earn"),
                BotCommand("transfer", "🔁 Transfer your plan"),
                BotCommand("info", "📄 Show your user info"),
                BotCommand("referral_list", "📋 View your referral list"),
                BotCommand("alpha", "🧪 Get info about FTM Alpha Mode"),
                BotCommand("restart", "🔄 Restart bot safely (Admin)"),
                BotCommand("add_premium", "💎 Add premium to a user (Admin)"),
                BotCommand("remove_premium", "🧱 Remove premium access (Admin)"),
                BotCommand("users", "👥 Show all users (Admin)"),
                BotCommand("pusers", "💠 Show premium users (Admin)"),
                BotCommand("makeadmin", "🤵 Add an admin (Admin)"),
                ...
                BotCommand("userstats", "📊 Show user stats (Admin)"),
                BotCommand("pnotify", "📣 Notify premium users (Admin)"),
                BotCommand("add_bal", "💰 Add balance to a user (Admin)"),
                BotCommand("unequify", "🧹 Remove duplicate messages"),
            ])
            logging.info("Bot command menu registered with Telegram")
